...
def run_eval(gt_path, detect_path):
    ...
    for threshold in iou_threshold:
        ...
        print(TP_scores.shape)
        print(FP_scores.shape)
        # print('compute_eval')
        # calculate precision, recall and VOC AP
        ap, mrec, mpre = compute_eval2(N_GT, TP_scores, FP_scores, 'result/pretrained/BWMaskRcnneval_aug')
        total_ap += ap
...
if __name__ == '__main__':
    ...
    gt_path = 'data/CutImage/instance_label'
    pred_path = 'result/pretrained/results_BWMaskRcnn'
